...
import jieba
import os
jieba.set_dictionary(os.path.join('society', 'models', 'dict.txt.big'))
...
class Classifier():
    ...
    def __init__(self):
        with open(os.path.join('society', 'models', 'cat_mapping'), 'r' , encoding='utf8') as f:
    ...
    def predict_cat(self, test_sentence):
        ...
        bst.load_model(os.path.join('society', 'models', '20171125 232430246178.model'))  # load data
